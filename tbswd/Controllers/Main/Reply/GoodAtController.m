...
{
    [super viewDidLoad];
    self.queListTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 64+42, 320, [UIScreen mainScreen].bounds.size.height-64-42-49)];
    ...
    topScrollView.titleArray = @[@"苹果中国苹果中国苹果中国苹果中国苹果中国", @"iCloud", @"新浪微薄", @"维基百科", @"百度", @"中国雅虎", @"新闻", @"流行"];
